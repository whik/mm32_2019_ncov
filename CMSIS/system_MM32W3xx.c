...
*    Then SystemInit() function is called, in "startup_MM32W3xx.s" file, to
...
*    the product used), refer to "HSE_VALUE" define in "MM32W3xx.h" file.
